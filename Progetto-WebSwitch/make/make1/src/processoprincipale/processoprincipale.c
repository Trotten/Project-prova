...
void *attesapipefiglio(void *arg){
	//funzione che viene eseguita dal thread del processo principale per rimanere in ascolto in lettura sulla pipe	
	//di comunicazione con un processo figlio
...
void creathreadpergestionepipefiglio(struct procinfo *data){			//funzione per la creazione del
										//thread (del processo principale) in 
										//ascolto sulla pipe 											//con il processo figlio
